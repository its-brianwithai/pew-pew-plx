...
- **Agent**: [[meta-sub-agent-architect]] - Expert in agent design patterns
...
- **Agent**: [[meta-sub-agent-architect]] - Expert in scope definition
...
- **Agent**: [[meta-sub-agent-architect]] - Expert in tool security
...
- **Agent**: [[meta-sub-agent-architect]] - Expert in naming conventions
...
- **Agent**: [[meta-sub-agent-architect]] - Expert in descriptions
...
- **Agent**: [[meta-sub-agent-architect]] - Expert in UI patterns
...
- **Agent**: [[meta-prompt-engineer]] - Expert in prompt crafting
...
- **Agent**: [[meta-prompt-engineer]] - Expert in instruction design
...
- **Agent**: [[meta-prompt-engineer]] - Expert in best practices
...
- **Agent**: [[meta-instructions-expert]] - Expert in rule creation
...
- **Agent**: [[meta-context-expert]] - Expert in documentation
...
- **Agent**: [[meta-sub-agent-architect]] - Expert in quality metrics
...
- **Agent**: [[meta-sub-agent-architect]] - Expert in validation
...
- **Agent**: [[meta-sub-agent-architect]] - Expert in comprehensive review
- **Inputs**: Complete agent definition
...
- **Agent**: [[meta-sub-agent-architect]] - Expert in wikilink validation
