---
description: Firebase Emulators - How we configure and manage Firebase emulators for local development
globs: *.json, *.sh, *.dart, *.rules
document_type: code_of_conduct
goal: Define standards and processes for configuring Firebase emulators in mono repo structure
gpt_action: Follow these steps when setting up and configuring Firebase emulators for local development
---
