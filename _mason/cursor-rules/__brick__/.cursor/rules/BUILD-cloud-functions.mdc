---
description: Cloud Functions - How we create and structure cloud functions
globs: *.ts, *.js, *.json
document_type: code_of_conduct
goal: Define standards and processes for creating new cloud functions
gpt_action: Follow these steps when creating or modifying cloud functions
---
