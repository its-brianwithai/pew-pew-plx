...
# CORE ------------------------------------------------------------
    ...
    "../_mason/cursor-rules/__brick__/.cursor/rules"
    "../_mason/scripts/__brick__/scripts"
# ISSUE -----------------------------------------------------------
...
for i in "${!source_paths[@]}"; do
    ...
    if [ -e "$source" ]; then
        if [ -d "$source" ]; then
            ...
            # Special handling for cursor-rules directory
            if [[ "$source" == *"cursor-rules"* ]]; then
                echo "Converting .md files to .mdc in cursor-rules..."
