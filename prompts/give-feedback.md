...
2. **Create Feedback Document**: Use the [[feedback-template]] to create a comprehensive feedback document following [[most-valuable-project-management-conventions]]. If the feedback relates to an existing issue, save it in that issue's folder. Otherwise, save it in the appropriate subject's backlog folder with the filename pattern: `feedback-[component-type]-[component-name]-[YYYYMMDD].md`
...
<output_format>
1. Create a feedback document using [[feedback-template]] following [[most-valuable-project-management-conventions]]
