...
---
````````````yaml
request: Create, update or transform the source into an instruction based on the user's request, iteratively refining it through questioning to ensure all conventions are captured without assumptions.
workflow:
