---
name: issue-template
description: "Template for breaking down requirements into clear, actionable work items. Starting point for any type of issue after which it can be broken down into epic milestones, stories and other types depending on the use case."
---
