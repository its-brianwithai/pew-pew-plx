...
- Follows @templates/plan/issue-template.md structure exactly
...
- @templates/plan/issue-template.md structure and conventions
...
### Deliverables
- Complete issue following @templates/plan/issue-template.md
...
Assemble into @templates/plan/issue-template.md:
