---
description: Dart Class Structure - How we organize and document Dart classes with clear sections
globs: lib/**/*.dart, test/**/*.dart
document_type: documentation_protocol
goal: Define standards for structuring Dart class code with consistent sections and organization
gpt_action: Read and apply section patterns when creating or modifying Dart class files
---
