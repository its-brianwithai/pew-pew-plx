---
description: Feature Breakdowns - How we create clear and structured feature documentation
globs: *.md, *.mdx, *.txt, *.json
document_type: code_of_conduct
goal: Define standards and processes for creating clear and effective feature breakdowns
gpt_action: Follow these guidelines when creating or modifying feature breakdown content
---
