...
> This bug report documents an issue that needs to be fixed, including steps to reproduce, expected vs actual behavior, and acceptance criteria for resolution.
