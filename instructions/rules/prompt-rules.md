...
- ALWAYS follow the exact structure from [[prompt-template]]
...
- NEVER deviate from [[prompt-template]] structure
...
- NEVER write examples that violate [[template-rules]]
...
- MUST follow [[prompt-template]] structure exactly
