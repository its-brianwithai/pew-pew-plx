...
4. Execute updates using appropriate agents:
   - Phase 1: @.claude/agents/discovery-agent.md with [[update-discovery]]
   - Phase 2: @.claude/agents/requirements-agent.md with [[update-requirements]]
   - Phase 3: @.claude/agents/refinement-agent.md with [[update-refinement]]
   - Phase 4: @.claude/agents/story-agent.md with [[update-story]]
   - Phase 5: @.claude/agents/roadmap-agent.md with [[update-roadmap]]
   - Phase 6: @.claude/agents/implementation-agent.md with [[update-implementation-plan]]
