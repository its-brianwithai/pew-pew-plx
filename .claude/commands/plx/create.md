...
- Structure using appropriate template:
  - Prompts → Follow @.claude/commands/use/prompt-template.md structure
  - Agents → Follow @.claude/commands/use/agent-template.md structure
  - Workflows → Follow @.claude/commands/use/workflow-template.md structure
...
**For Prompts:**
- Follow @.claude/commands/use/prompt-template.md structure for organization
...
**For Agents:**
- Follow @.claude/commands/use/agent-template.md with all required sections
...
**For Workflows:**
- Follow @.claude/commands/use/workflow-template.md for sophisticated orchestrations
