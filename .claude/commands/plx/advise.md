...
---
role: @.claude/agents/ultra-meta-agent.md or @.claude/agents/meta-feature-agent.md
...
4. **ITERATIVE PHASE EXECUTION:** Execute each phase by embodying the relevant agent:
   ...
   **Phase 1 - Discovery & Context Gathering:**
   - Read and embody @.claude/agents/discovery-agent.md persona
   ...
   **Phase 2 - Requirements Elaboration:**
   - Read and embody @.claude/agents/requirements-agent.md persona
   ...
   **Phase 3 - Refinement & Architecture:**
   - Read and embody @.claude/agents/refinement-agent.md persona
   ...
   **Phase 4 - Story Creation & Detailing:**
   - Read and embody @.claude/agents/story-agent.md persona
   ...
   **Phase 5 - Milestone & Roadmap Planning:**
   - Read and embody @.claude/agents/roadmap-agent.md persona
   - Update questions document with new section covering:
   ...
   **Phase 6 - Implementation Planning:**
   - Read and embody @.claude/agents/implementation-agent.md persona
   - Update questions document with new section addressing:
...
- @.claude/agents/discovery-agent.md - (Relevance: Phase 1 patterns and discovery techniques)
- @.claude/agents/requirements-agent.md - (Relevance: Phase 2 activity flow design patterns)
- @.claude/agents/refinement-agent.md - (Relevance: Phase 3 technical specification approaches)
- @.claude/agents/story-agent.md - (Relevance: Phase 4 user story creation patterns)
- @.claude/agents/roadmap-agent.md - (Relevance: Phase 5 milestone planning strategies)
- @.claude/agents/implementation-agent.md - (Relevance: Phase 6 technical planning methods)
