...
- Ensure consistency with project's documentation standards and @.claude/commands/use/agent-template.md structure
...
- @.claude/commands/use/agent-template.md - (Relevance: Standard structure for all agent documentation)
