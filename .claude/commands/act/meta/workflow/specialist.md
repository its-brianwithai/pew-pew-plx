...
- WHEN writing outputs ALWAYS follow @.claude/commands/use/workflow-template.md
...
- @.claude/commands/use/workflow-template.md - (Relevance: Required output structure for sophisticated workflows)
