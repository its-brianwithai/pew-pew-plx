...
3. **DEVELOP - Research and Apply Expertise:** Based on artifact type, examine:
   ...
   - For Agents: [[claude-code-sub-agent-docs]], @.claude/commands/use/agent-template.md, existing `agents/`
   - For Templates: `blocks/` directory for patterns, @.claude/commands/use/agent-template.md, existing `templates/`
   - For Workflows: @.claude/commands/use/workflow-template.md, [[refinement-workflow]], [[issue-workflow-example-wiki-link]] existing `workflows/`
...
4. **Apply Type-Specific Expertise:**
   ...
   **For Agents (Sub-agent Architecture):**
   ...
   - Structure with all required sections from @.claude/commands/use/agent-template.md
...
- Reference @.claude/agents/meta-prompt-engineer.md, @.claude/agents/meta-sub-agent-architect.md, @.claude/agents/meta-template-expert.md, @.claude/agents/meta-workflow-specialist.md, @.claude/agents/meta-context-expert.md, and @.claude/agents/meta-instructions-expert.md for deep expertise in specific areas
...
- @.claude/commands/use/agent-template.md - (Relevance: Standard structure for agents and reference for templates)
- @.claude/commands/use/workflow-template.md - (Relevance: Workflow structure and orchestration patterns)
...
- @.claude/agents/meta-prompt-engineer.md - (Relevance: Deep prompt engineering expertise)
- @.claude/agents/meta-sub-agent-architect.md - (Relevance: Agent creation best practices)
- @.claude/agents/meta-template-expert.md - (Relevance: Template architecture patterns)
- @.claude/agents/meta-workflow-specialist.md - (Relevance: Workflow orchestration expertise)
- @.claude/agents/meta-context-expert.md - (Relevance: Context documentation patterns)
- @.claude/agents/meta-instructions-expert.md - (Relevance: Instruction documentation standards)
...
- **Agents:** Write to `agents/<agent-name>.md` following @.claude/commands/use/agent-template.md
