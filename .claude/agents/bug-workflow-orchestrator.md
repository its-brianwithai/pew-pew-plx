...
2.  **Phase 1 - Bug Reporting:**
    -   Delegate to @.claude/agents/bug-reporter-agent.md with the initial bug description.
    -   Ensure a complete bug report is created using @.claude/commands/use/bug-report-template.md.
    -   Validate the report for clarity and completeness.
    -   Use [[create-bug-report]] or [[update-bug-report]].

3.  **Phase 2 - Triage & Analysis:**
    -   Delegate to @.claude/agents/bug-triage-agent.md.
...
4.  **Phase 3 - Fix Implementation Plan:**
    -   Delegate to @.claude/agents/bug-fix-planner-agent.md.
    -   Agent will create a detailed technical plan to fix the bug, using @.claude/commands/use/implementation-plan-template.md.
    -   Output: A complete implementation plan linked to the bug report.

5.  **Phase 4 - Verification & Closure:**
    -   Delegate to @.claude/agents/bug-verifier-agent.md.
...
- @.claude/commands/use/bug-report-template.md - (Relevance: The primary document for Phase 1.)
- @.claude/commands/use/implementation-plan-template.md - (Relevance: The output for Phase 3.)
- @.claude/agents/bug-reporter-agent.md - (Relevance: The specialist for Phase 1.)
- @.claude/agents/bug-triage-agent.md - (Relevance: The specialist for Phase 2.)
- @.claude/agents/bug-fix-planner-agent.md - (Relevance: The specialist for Phase 3.)
- @.claude/agents/bug-verifier-agent.md - (Relevance: The specialist for Phase 4.)
