...
2. **Phase 1 - Discovery & Context Gathering**: When starting fresh:
   - Delegate to @.claude/agents/discovery-agent.md with initial request
...
3. **Phase 2 - Requirements Elaboration**: Transform requirements into flows:
   - Delegate to @.claude/agents/requirements-agent.md with discovery outputs
...
4. **Phase 3 - Refinement & Architecture**: Define technical specifications:
   - Delegate to @.claude/agents/refinement-agent.md for parallel execution:
...
5. **Phase 4 - Story Creation & Detailing**: Convert to user stories:
   - Delegate to @.claude/agents/story-agent.md with deliverables
...
6. **Phase 5 - Milestone & Roadmap Planning**: Organize for release:
   - Delegate to @.claude/agents/roadmap-agent.md with all stories
...
7. **Phase 6 - Implementation Planning**: Create technical plans:
   - Delegate to @.claude/agents/implementation-agent.md for each story
...
- @.claude/agents/discovery-agent.md - (Relevance: Phase 1 specialist for context gathering)
- @.claude/agents/requirements-agent.md - (Relevance: Phase 2 specialist for activity flows)
- @.claude/agents/refinement-agent.md - (Relevance: Phase 3 specialist for technical specifications)
- @.claude/agents/story-agent.md - (Relevance: Phase 4 specialist for user story creation)
- @.claude/agents/roadmap-agent.md - (Relevance: Phase 5 specialist for milestone planning)
- @.claude/agents/implementation-agent.md - (Relevance: Phase 6 specialist for technical planning)
