...
2. **Research Project Conventions:** Use `Read` to examine @.claude/commands/use/agent-template.md and any relevant documentation in `instructions/` or `blocks/` to understand:
...
7. **Structure the System Prompt:** Create comprehensive prompt following project patterns from @.claude/commands/use/agent-template.md:
...
10. **DELIVER - Write Agent File:** Create the complete agent file in `agents/<agent-name>.md` with:
   ...
   - All sections from @.claude/commands/use/agent-template.md with appropriate content
...
- Populate all sections from @.claude/commands/use/agent-template.md with relevant content
...
- Consult @.claude/agents/meta-prompt-engineer.md when crafting complex agent prompts needing XML structure, chain-of-thought reasoning, or advanced prompting techniques
...
- WHEN analyzing requirements ALWAYS examine @.claude/commands/use/agent-template.md and project documentation
...
- WHEN structuring the agent ALWAYS follow the template structure from @.claude/commands/use/agent-template.md
...
2. Follow the exact structure from @.claude/commands/use/agent-template.md
