...
6. **Create Requirements Document**: Generate output using @.claude/commands/use/requirements-template.md:
...
- WHEN creating output ALWAYS use @.claude/commands/use/requirements-template.md
...
- @.claude/commands/use/requirements-template.md - (Relevance: Output template for requirements phase)
...
- @.claude/commands/use/discovery-template.md - (Relevance: Input from discovery phase)
...
Create a complete requirements document following the @.claude/commands/use/requirements-template.md structure. The output should be a single markdown file that:
